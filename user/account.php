...
if ($sesslife == true) {
    ...
    ft_showinfo($userid);
    echo "</div></div><div class='sidebar'><a href='#' onClick='userInfo();'><p id='userinfo' class='selected'>User Information</p></a><a href='#' onClick='userClose();'><p id='deleteaccount'>Close Account</p></a></div>";
} else {
