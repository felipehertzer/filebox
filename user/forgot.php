        ...
        if ($email != "") {
            ...
            if ($resp->is_valid) {
                ...
                if ($n) {
                    ...
                    $err = "<div class='infobox'><p>{$lang[52]}</p></div>";
                    am_showForgot();
                } else {
...
function am_showForgot()
{
    ...
    global $err; ?>
    <center>
        <form method='POST' action='<?php echo $website; ?>/user/forgot.php'>
            <div class='logindiv'>
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td><input type='submit' name='forgot' class='button' value='<?php echo $lang[8]; ?>'/></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><small><?php echo $lang[10]; ?> <?php echo $webtitle; ?>? <a
                                        href='<?php echo $website; ?>/user/login.php'><?php echo $lang[11]; ?></a></small>
                        </td>
                    </tr>
                </table>
            </div>
