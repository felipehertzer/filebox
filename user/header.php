...
function subheader($title, $css = "", $js = "", $cl = "")
{
    ...
    if ($sesslife == true) {
        if ($premium == 1) {
            $current_time = time();
            $query_time = mysqli_query($link, "SELECT * FROM `transactions` WHERE(`userid`={$userid}) ORDER BY `transaction_id` DESC LIMIT 1") or die(mysqli_error($link));
        ...
        <div id="limitheader">
            ...
            <div id="subheader">
                <ul class="header">
                    ...
                    <li<?php if ($cl == 'files') {
                        echo " class=\"selected\"";
                    } ?>><a href="<?php echo $website; ?>/user/myfiles.php">My Files</a></li>
                ...
                <ul class="rightheader">
                    ...
                    <?php if ($sesslife == false) { ?>
                        <li><a href="#" onClick="fblogin();"><img src="<?php echo $website; ?>/images/fb_connect.gif"
                                                                  style="vertical-align:middle;"/></a></li>
                        <li<?php if ($cl == 'login') {
                            echo " class=\"selected\"";
                        } ?>><a href="<?php echo $website; ?>/user/login.php">Login</a></li>
                    ...
                    <?php } else { ?>
                        ...
                        <li<?php if ($cl == 'account') {
                            echo " class=\"selected\"";
                        } ?>><a href="<?php echo $website; ?>/user/account.php">Account</a></li>
