        ...
        if ($key != "") {
            ...
            if ($n) {
                ...
                if ($verify == 0) {
                    ...
                    echo "<center><div class='errorbox' style='width:96%;'><p>{$lang[93]}</p></div></center><br/><br/>";
                }
            } else {
                echo "<center><div class='errorbox' style='width:96%;'><p>{$lang[94]}<br/><small>{$lang[44]} <a href='{$website}/static/contact.php'>{$lang[46]}</a>.</small></p></div></center><br/><br/>";
            }
        } else {
            echo "<center><div class='errorbox' style='width:96%;'><p>{$lang[95]}<br/><small>{$lang[47]}</small></p></div></center><br/><br/>";
        }
    } else {
        echo "<center><div class='errorbox' style='width:96%;'><p>{$lang[95]}<br/><small>{$lang[47]}</small></p></div></center><br/><br/>";
    }
} else {
    echo "<center><div class='errorbox' style='width:96%;'><p>{$lang[40]}</p></div></center><br/><br/>";
}
include("footer.php");
