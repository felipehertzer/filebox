...
?>
		...
		<div id='emaildiv-header' style='height:40px;'><p><img src='<?php echo $website; ?>/images/icons/eraser.png' style='width:24px;height:24px;' /> File Information <small>(Edit file information over here)</small></p></div>
		<?php echo $err; ?>
		<form action="<?php echo $website; ?>/user/editinfo.php?id=<?php echo $id; ?>" method="POST" accept-charset="utf-8" id="compose">
		<table id='messagecompose'>
		<tr><td class='first' style='text-align:left;'>File Name:</td></tr>
		<tr><td>
        <input type='text' name='filename' value='<?php echo $filename; ?>' class='filename' /><br/><small>(Must not be blank)</small>
		</td></tr>
		<tr><td class='first' style='text-align:left;'>Description:</td></tr>
		<tr><td>
        <textarea name='description'><?php echo $description; ?></textarea><br/><small>(Not more than 2000 characters)</small>
		</td></tr>
		<tr><td><input type='submit' class='button' value='Edit Description' name='editInfo' /></td></tr>
		</table>
		</form>
		</div>
