    ...
    switch ($s) {
        ...
        case 'process':      // Process and order...
            ...
            if ($sesslife == true) {
                ...
                echo "<div class='errorbox'><p>Session expired.</p></div><br/><p class='margin'>You are not allowed to perform this action. You must <a href='{$website}/user/login.php'>login</a> to the website before you can go for premium membership.</p>";
            }
