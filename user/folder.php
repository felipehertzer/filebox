<?php
 ...
 include("../init.php");
 include("../modules/CreateZipFile.inc.php"); $err = "";
 if($sesslife == true) {
...
<?php echo "<div class='global'>";
	...
	$file_user[] = $sql_f['userid']; $views[] = $sql_f['views'];
	}
	...
	<li>Sort By:</li><a href='?id=<?php echo $id; ?>&o=id'><li<?php if($_SESSION['order'] == "ORDER BY `id`") { echo " class='selected'"; } ?>>Recent</li></a>
	<a href='?id=<?php echo $id; ?>&o=name'><li<?php if($_SESSION['order'] == "ORDER BY `name`") { echo " class='selected'"; } ?>>Name</li></a>
	<a href='?id=<?php echo $id; ?>&o=date'><li<?php if($_SESSION['order'] == "ORDER BY `date`") { echo " class='selected'"; } ?>>Date</li></a>
	<a href='?id=<?php echo $id; ?>&o=size'><li<?php if($_SESSION['order'] == "ORDER BY `size`") { echo " class='selected'"; } ?>>Size</li></a>
	<a href='?id=<?php echo $id; ?>&o=downloads'><li<?php if($_SESSION['order'] == "ORDER BY `downloads`") { echo " class='selected'"; } ?>>Downloads</li></a>
	</ul></div>
...
<?php echo "<div id='ajax'></div>";
	...
	$s = $size[$i]; $file_name = $fname[$i]; $ff = $filter[$i]; $is_f = $is_folder[$i]; $file_uid = $file_user[$i];
	$v = $views[$i];
	...
	if($sesslife == true) { if($file_uid == $userid) {
 ...
 if($sesslife == true) {
	if(isset($_GET['id'])) {
		if(mysqli_num_rows($check_query)) { 
			...
			} else { echo "<div class='sidebar'><a href='#' onClick='bulkFiles();'><p id='bulk'>Bulk Download Selected</p></a></div>"; } 
		} 
	} 
 } else { echo "<div class='sidebar'><a href='#' onClick='bulkFiles();'><p id='bulk'>Bulk Download Selected</p></a></div>"; }
